...
Route::middleware(['auth:sanctum', 'arabic_numbers'])->group(function () {
    ...
    Route::prefix('manager')->group(function () { //->middleware(['role:manager'])
        ...
        Route::get('schools/{school}/stats', App\Http\Controllers\Api\Manager\StatsController::class)->name('manager.stats');
        Route::apiResources([
            ...
            'schools.lectures' => App\Http\Controllers\Api\Manager\SchoolLecturesController::class,
    ...
    Route::prefix('admin')->middleware(['role:admin'])->group(function () { //
        ...
        Route::post('students/{student}/password-reset', [App\Http\Controllers\Api\Admin\Students::class, 'password_reset'])->name('students.password-reset');
